...
![23f0288a5ba4388f69e5a1c3a59eb55f.png][]
...
Python 和 C++ / Java 最大的不同在于，后者完全使用大括号来区分代码块，而前者依靠不同行和不同的缩进来进行分块。有一个很有名的比赛，叫作 [C 语言混乱代码大赛][C]，其中有很多非常精彩的作品，你能看到书写的代码排成各种形状，有的是一幅画，或者一个卡通头像，但是能执行出惊人的结果。
...
[23f0288a5ba4388f69e5a1c3a59eb55f.png]: https://static001.geekbang.org/resource/image/23/5f/23f0288a5ba4388f69e5a1c3a59eb55f.png
[C]: http://www.ioccc.org/years-spoiler.html
